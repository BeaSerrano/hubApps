...
export const initControler = (pagesRender) => {
  ...
  switch (pagesRender) {
    case undefined:
      ...
      break;
    case "Pokemon":
      PrintPokemonPage(); // devuelve la pagina de pokemon
      break;
    case "Dashboard":
      printTemplateDashboard(); // devuelve la home
      break;
    case "Topo":
      "Topo()"; // aqui ahora no hay nada
      break;
    case "Login":
      Login(); // devuelve pagina de login
      break;
    case "Memory":
      "Memory()"; // aqui ahora no hay nada
      break;
  }
};
